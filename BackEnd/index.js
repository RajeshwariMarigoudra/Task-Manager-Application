...
app.use(
  cors({
    origin: process.env.FRONTEND_DOMAIN, // This should be your frontend URL
    credentials: true,  // Allow cookies or sessions to be passed
    methods: ["GET", "POST", "PUT", "PATCH", "DELETE"], // Allowed methods
  })
);
// Express middleware to handle JSON and URL-encoded data
